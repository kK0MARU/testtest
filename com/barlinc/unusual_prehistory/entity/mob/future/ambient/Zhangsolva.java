...
extends AmbientMob {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.m_21552_().m_22268_(Attributes.f_22276_, 1.0).m_22268_(Attributes.f_22279_, (double)0.01f).m_22268_(Attributes.f_22280_, 0.5);
    }

    protected void m_8099_() {
        this.f_21345_.m_25352_(0, (Goal)new FloatGoal((Mob)this));
        this.f_21345_.m_25352_(1, (Goal)new ZhangsolvaWanderAroundGoal(this));
        this.f_21345_.m_25352_(2, (Goal)new ZhangsolvaLookAroundGoal(this));
    }
    ...
    protected PathNavigation m_6037_(@NotNull Level level) {
        NoSpinFlyingPathNavigation flyingPathNavigation = new NoSpinFlyingPathNavigation((Mob)this, level){
            ...
            public boolean m_6342_(BlockPos blockPos) {
                return !Zhangsolva.this.m_9236_().m_8055_(blockPos.m_7495_()).m_60795_();
            }
        };
    ...
    private static class ZhangsolvaWanderAroundGoal
    extends Goal {
        ...
        public boolean m_8036_() {
            return this.zhangsolva.f_21344_.m_26571_() && this.zhangsolva.f_19796_.m_188503_(20) == 0;
        }

        public boolean m_8045_() {
            return this.zhangsolva.f_21344_.m_26572_();
        }

        public void m_8056_() {
            Vec3 vec3d = this.getRandomLocation();
            if (vec3d != null) {
                this.zhangsolva.f_21344_.m_26536_(this.zhangsolva.f_21344_.m_7864_(BlockPos.m_274446_((Position)vec3d), 1), 1.0);
            }
        }

        @Nullable
        private Vec3 getRandomLocation() {
            Vec3 vec3d2 = this.zhangsolva.m_20252_(0.0f);
            Vec3 vec3d3 = HoverRandomPos.m_148465_((PathfinderMob)this.zhangsolva, (int)10, (int)3, (double)vec3d2.f_82479_, (double)vec3d2.f_82481_, (float)1.5707964f, (int)3, (int)1);
            return vec3d3 != null ? vec3d3 : AirAndWaterRandomPos.m_148357_((PathfinderMob)this.zhangsolva, (int)10, (int)2, (int)-2, (double)vec3d2.f_82479_, (double)vec3d2.f_82481_, (double)1.5707963705062866);
        }
    }

    private class ZhangsolvaLookAroundGoal
    extends RandomLookAroundGoal {
        private final Zhangsolva zhangsolva;

        public ZhangsolvaLookAroundGoal(Zhangsolva zhangsolva2) {
            super((Mob)Zhangsolva.this);
            this.zhangsolva = zhangsolva2;
        }

        public boolean m_8036_() {
            return this.zhangsolva.m_20096_() && super.m_8036_();
        }

        public boolean m_8045_() {
            return this.zhangsolva.m_20096_() && super.m_8045_();
        }
    }
}
