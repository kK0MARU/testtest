...
import com.barlinc.unusual_prehistory.entity.mob.future.PalaeophisPart;
...
extends PrehistoricAquaticMob {
    ...
    public Palaeophis(EntityType<? extends PrehistoricAquaticMob> entityType, Level level) {
        ...
        this.body1Part = new PalaeophisPart(this, (Entity)this, 1.8f, 1.2f);
        this.body2Part = new PalaeophisPart(this, (Entity)this.body1Part, 1.8f, 1.2f);
        this.body3Part = new PalaeophisPart(this, (Entity)this.body2Part, 1.8f, 1.2f);
        this.tail1Part = new PalaeophisPart(this, (Entity)this.body3Part, 1.8f, 1.2f);
        this.tail2Part = new PalaeophisPart(this, (Entity)this.tail1Part, 1.5f, 1.2f);
        this.tail3Part = new PalaeophisPart(this, (Entity)this.tail2Part, 1.25f, 1.2f);
        this.allParts = new PalaeophisPart[]{this.body1Part, this.body2Part, this.body3Part, this.tail1Part, this.tail2Part, this.tail3Part};
        this.m_20234_(f_19843_.getAndAdd(this.allParts.length + 1) + 1);
        this.fakeYRot = this.m_146908_();
    }

    public static AttributeSupplier.Builder createAttributes() {
        return Mob.m_21552_().m_22268_(Attributes.f_22276_, 60.0).m_22268_(Attributes.f_22281_, 6.0).m_22268_(Attributes.f_22279_, 0.75);
    }
    ...
    public void m_142687_(@NotNull Entity.RemovalReason removalReason) {
        ...
        if (this.allParts != null) {
            for (PalaeophisPart part : this.allParts) {
    ...
    private void tickMultipart() {
        ...
        this.body1Part.setPosCenteredY(this.rotateOffsetVec(new Vec3(0.0, 0.0, (double)-2.2f), this.m_146909_() * 0.25f, this.m_6080_()).m_82549_(center));
        this.body2Part.setPosCenteredY(this.rotateOffsetVec(new Vec3(0.0, 0.0, (double)-2.2f), this.m_146909_() * 0.25f, this.getYawFromBuffer(2, 1.0f)).m_82549_(this.body1Part.centeredPosition()));
        this.body3Part.setPosCenteredY(this.rotateOffsetVec(new Vec3(0.0, 0.0, (double)-2.2f), this.m_146909_() * 0.25f, this.getYawFromBuffer(4, 1.0f)).m_82549_(this.body2Part.centeredPosition()));
        this.tail1Part.setPosCenteredY(this.rotateOffsetVec(new Vec3(0.0, 0.0, (double)-2.2f), this.m_146909_() * 0.25f, this.getYawFromBuffer(6, 1.0f)).m_82549_(this.body3Part.centeredPosition()));
        this.tail2Part.setPosCenteredY(this.rotateOffsetVec(new Vec3(0.0, 0.0, (double)-2.2f), this.m_146909_() * 0.25f, this.getYawFromBuffer(8, 1.0f)).m_82549_(this.tail1Part.centeredPosition()));
        this.tail3Part.setPosCenteredY(this.rotateOffsetVec(new Vec3(0.0, 0.0, (double)-2.2f), this.m_146909_() * 0.25f, this.getYawFromBuffer(10, 1.0f)).m_82549_(this.tail2Part.centeredPosition()));
    ...
    public AgeableMob m_142606_(@NotNull ServerLevel serverLevel, @NotNull AgeableMob ageableMob) {
        Palaeophis palaeophis = (Palaeophis)((EntityType)UP2Entities.PALAEOPHIS.get()).m_20615_((Level)serverLevel);
