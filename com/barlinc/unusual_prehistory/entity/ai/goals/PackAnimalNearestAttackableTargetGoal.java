...
public class PackAnimalNearestAttackableTargetGoal<T extends LivingEntity>
extends PrehistoricNearestAttackableTargetGoal<T> {
    ...
    public PackAnimalNearestAttackableTargetGoal(PrehistoricMob mob, Class<T> targetClass, boolean mustSee, int packSizeRequired) {
        ...
        this.packAnimal = (PackAnimal)((Object)mob);
    ...
    public boolean m_8036_() {
        if (super.m_8036_()) {
            return this.packAnimal.getPackSize() >= this.packSizeRequired;
        }
        return false;
    }
}
