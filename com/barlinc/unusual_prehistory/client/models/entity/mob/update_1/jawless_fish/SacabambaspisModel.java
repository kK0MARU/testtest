...
public class SacabambaspisModel
extends UP2Model<JawlessFish> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition swim_control = root.m_171599_("swim_control", CubeListBuilder.m_171558_(), PartPose.m_171419_((float)0.0f, (float)-2.0f, (float)-2.5f));
        PartDefinition body_sideways = swim_control.m_171599_("body_sideways", CubeListBuilder.m_171558_(), PartPose.m_171419_((float)0.0f, (float)0.0f, (float)-0.5f));
        PartDefinition body = body_sideways.m_171599_("body", CubeListBuilder.m_171558_().m_171514_(0, 0).m_171488_(-3.0f, -2.0f, -3.0f, 6.0f, 4.0f, 7.0f, new CubeDeformation(0.0f)), PartPose.m_171419_((float)0.0f, (float)0.0f, (float)0.0f));
        PartDefinition tail1 = body.m_171599_("tail1", CubeListBuilder.m_171558_().m_171514_(3, 14).m_171488_(0.0f, -1.5f, 0.0f, 0.0f, 3.0f, 6.0f, new CubeDeformation(0.001f)), PartPose.m_171419_((float)0.0f, (float)-0.5f, (float)4.0f));
        PartDefinition tail2 = tail1.m_171599_("tail2", CubeListBuilder.m_171558_().m_171514_(0, 9).m_171488_(0.0f, -3.0f, 0.0f, 0.0f, 5.0f, 6.0f, new CubeDeformation(0.001f)), PartPose.m_171419_((float)0.0f, (float)0.5f, (float)6.0f));
