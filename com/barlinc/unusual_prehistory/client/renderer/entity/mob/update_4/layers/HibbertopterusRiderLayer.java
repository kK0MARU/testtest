...
public class HibbertopterusRiderLayer
extends RiderLayer<Hibbertopterus, HibbertopterusModel> {
    ...
    public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, Hibbertopterus entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.m_20160_()) {
            Vec3 offset = new Vec3(0.0, (double)0.2f, (double)0.6f);
            Vec3 ridePos = ((HibbertopterusModel)this.m_117386_()).getRiderPosition(offset);
            for (Entity passenger : entity.m_20197_()) {
                ...
                poseStack.m_85836_();
                ((HibbertopterusModel)this.m_117386_()).positionRider(poseStack);
                ...
                HibbertopterusRiderLayer.renderPassenger(passenger, 0.0, 0.0, 0.0, 0.0f, partialTicks, poseStack, bufferSource, packedLight);
                poseStack.m_85849_();
