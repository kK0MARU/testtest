...
public class HibbertopterusRenderer
extends MobRenderer<Hibbertopterus, HibbertopterusModel> {
    ...
    public HibbertopterusRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new HibbertopterusModel(context.m_174023_(UP2ModelLayers.HIBBERTOPTERUS)), 1.2f);
        this.m_115326_(new HibbertopterusRiderLayer((RenderLayerParent<Hibbertopterus, HibbertopterusModel>)this));
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Hibbertopterus entity) {
        return TEXTURE;
    }
}
