...
public class PraepusaRenderer
extends MobRenderer<Praepusa, PraepusaModel> {
    ...
    public PraepusaRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new PraepusaModel(context.m_174023_(UP2ModelLayers.PRAEPUSA)), 0.4f);
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Praepusa entity) {
        return TEXTURE;
    }
}
