...
public class LeptictidiumRenderer
extends MobRenderer<Leptictidium, LeptictidiumModel> {
    ...
    public LeptictidiumRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new LeptictidiumModel(context.m_174023_(UP2ModelLayers.LEPTICTIDIUM)), 0.2f);
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Leptictidium entity) {
        return TEXTURE;
    }
}
