...
public class ManipulatorRenderer
extends MobRenderer<Manipulator, ManipulatorModel> {
    ...
    public ManipulatorRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new ManipulatorModel(context.m_174023_(UP2ModelLayers.MANIPULATOR)), 0.9f);
        this.m_115326_(new ManipulatorHeldItemLayer((RenderLayerParent<Manipulator, ManipulatorModel>)this, context.m_234598_()));
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Manipulator entity) {
        return TEXTURE;
    }
}
