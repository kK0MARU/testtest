...
public class BarinasuchusRiderLayer
extends RiderLayer<Barinasuchus, BarinasuchusModel> {
    ...
    public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, Barinasuchus entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.m_20160_()) {
            Vec3 offset = new Vec3(0.0, (double)0.12f, 0.0);
            Vec3 ridePos = ((BarinasuchusModel)this.m_117386_()).getRiderPosition(offset);
            for (Entity passenger : entity.m_20197_()) {
                ...
                poseStack.m_85836_();
                ((BarinasuchusModel)this.m_117386_()).translateRiderToBody(poseStack);
                ...
                BarinasuchusRiderLayer.renderPassenger(passenger, 0.0, 0.0, 0.0, 0.0f, partialTicks, poseStack, bufferSource, packedLight);
                poseStack.m_85849_();
