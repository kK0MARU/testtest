...
public class PsilopterusRenderer
extends MobRenderer<Psilopterus, PsilopterusModel> {
    ...
    public PsilopterusRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new PsilopterusModel(context.m_174023_(UP2ModelLayers.PSILOPTERUS)), 0.4f);
    }
    ...
    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Psilopterus entity) {
        if (entity.isPackLeader()) {
            return entity.isEepy() ? TEXTURE_ALPHA_EEPY : TEXTURE_ALPHA;
        }
