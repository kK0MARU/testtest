...
public class KentrosaurusRenderer
extends MobRenderer<Kentrosaurus, KentrosaurusModel> {
    ...
    public KentrosaurusRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new KentrosaurusModel(context.m_174023_(UP2ModelLayers.KENTROSAURUS)), 1.0f);
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Kentrosaurus entity) {
