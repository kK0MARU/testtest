...
public class TelecrexRenderer
extends MobRenderer<Telecrex, TelecrexModel> {
    ...
    public TelecrexRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new TelecrexModel(context.m_174023_(UP2ModelLayers.TELECREX)), 0.4f);
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Telecrex entity) {
        return TEXTURE;
    }
}
