...
public class KimmeridgebrachypteraeschnidiumNymphRenderer
extends MobRenderer<KimmeridgebrachypteraeschnidiumNymph, KimmeridgebrachypteraeschnidiumNymphModel> {
    ...
    public KimmeridgebrachypteraeschnidiumNymphRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new KimmeridgebrachypteraeschnidiumNymphModel(context.m_174023_(UP2ModelLayers.KIMMERIDGEBRACHYPTERAESCHNIDIUM_NYMPH)), 0.2f);
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull KimmeridgebrachypteraeschnidiumNymph entity) {
        return TEXTURE;
    }
}
