...
public class MetriorhynchusRenderer
extends MobRenderer<Metriorhynchus, MetriorhynchusModel> {
    ...
    public MetriorhynchusRenderer(EntityRendererProvider.Context context) {
        super(context, (EntityModel)new MetriorhynchusModel(context.m_174023_(UP2ModelLayers.METRIORHYNCHUS)), 0.8f);
        this.m_115326_(new MetriorhynchusHeldMobLayer((RenderLayerParent<Metriorhynchus, MetriorhynchusModel>)this));
    }

    @NotNull
    public ResourceLocation getTextureLocation(@NotNull Metriorhynchus entity) {
        return TEXTURE;
    }
}
