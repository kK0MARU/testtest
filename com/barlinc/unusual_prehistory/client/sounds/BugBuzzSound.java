...
public class BugBuzzSound
extends AbstractTickableSoundInstance {
    protected final AmbientMob entity;

    public BugBuzzSound(AmbientMob entity) {
        super((SoundEvent)UP2SoundEvents.BUG_BUZZ.get(), SoundSource.NEUTRAL, SoundInstance.m_235150_());
        this.entity = entity;
    ...
    public void m_7788_() {
        ...
        if (!this.entity.m_20096_()) {
            this.f_119574_ = Mth.m_14179_((float)Mth.m_14036_((float)horizontalDistance, (float)1.0f, (float)1.25f), (float)1.0f, (float)1.25f);
            this.f_119573_ = Mth.m_14179_((float)Mth.m_14036_((float)horizontalDistance, (float)0.0f, (float)0.2f), (float)0.1f, (float)0.2f);
        } else {
            this.f_119573_ = 0.0f;
            this.f_119574_ = 0.0f;
        }
